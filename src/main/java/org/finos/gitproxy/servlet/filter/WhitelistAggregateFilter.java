...
/**
 * An aggregate filter that applies a list of {@link WhitelistByUrlFilter} filters to a given request and provider.
 * This filter is used to iterate through the list of whitelists and only block the request if it does not match any of
 * the whitelists.
 */
@Slf4j
@ToString
public class WhitelistAggregateFilter extends AbstractProviderAwareGitProxyFilter {
    ...
    public WhitelistAggregateFilter(int order,
