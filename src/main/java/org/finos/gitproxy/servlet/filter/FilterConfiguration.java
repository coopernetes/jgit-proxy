...
//        BindResult<GitProxyProperties> bindResult = Binder.get(environment).bind("git-proxy",
...
//                        log.warn(
//                                "Multiple targets has been configured for this a single whitelist filter ({}), order
// will be adjusted for specificity",
//                                props);
//                    }
...
//                                // begins colliding with other filters in the overall chain. The best thing to do is
// to
