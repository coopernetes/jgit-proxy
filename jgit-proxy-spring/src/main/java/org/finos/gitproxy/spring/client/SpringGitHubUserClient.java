package org.finos.gitproxy.spring.client;
...
/**
 * Spring {@link RestClient}-based implementation of {@link GitHubUserClient} that validates GitHub tokens by calling
 * the GitHub API.
 */
@Slf4j
@RequiredArgsConstructor
public class SpringGitHubUserClient implements GitHubUserClient {
